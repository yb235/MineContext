...
class IntentNode(BaseNode):
    ...
    async def process(self, state: WorkflowState) -> WorkflowState:
        ...
        state.intent = Intent(
            ...
            enhanced_query=state.query.text
        )
    ...
    async def _enhance_complex_query(self, state: WorkflowState, query_type: QueryType) -> WorkflowState:
        ...
        user_prompt = prompt_template["user"].format(
            ...
            enhancement_results=json.dumps(enhancement_results, ensure_ascii=False) if enhancement_results else "",
